...
class Snake:
     def __init__(self):
          ...
          self.eat_sound = pygame.mixer.Sound("Sounds/retro_coin.mp3")
...
class Game:
     ...
     def check_collision_with_tail(self):
          ...
          if self.snake.body[0] in snake_body:
               self.gameover()
...
while True:
    ...
    #Drawing
    screen.fill(GREEN)
    pygame.draw.rect(screen, DARK_GREEN, (OFFSET-5, OFFSET-5, cell_size*number_of_cells+10, cell_size*number_of_cells+10), 4)
    game.draw()

    title_surface = title_font.render("RETRO SNAKE", True, DARK_GREEN)
    screen.blit(title_surface, (OFFSET+5, 50))

    score_surface = score_font.render(str(game.score), True, DARK_GREEN)
    screen.blit(score_surface, (OFFSET+705, 50))
